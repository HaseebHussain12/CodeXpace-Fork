      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-2">
                ...
                <p className="text-gray-400 text-sm">117 S LEXINGTON<br />Harrisonville, MO US</p>
              </div>
              <div className="flex items-center space-x-2">
                ...
                <a href="tel:+61469021387" className="text-gray-400 text-sm hover:text-red-400 transition-colors">
                  +61469021387
                </a>
              </div>
              <div className="flex items-center space-x-2">
                ...
                <a href="mailto:director@codexpace.com" className="text-gray-400 text-sm hover:text-red-400 transition-colors">
                  director@codexpace.com
                </a>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <Link href="/privacy-policy" className="block text-gray-400 text-sm hover:text-red-400 transition-colors">
                Privacy Policy
              </Link>
              <Link href="/refund-policy" className="block text-gray-400 text-sm hover:text-red-400 transition-colors">
                Refund Policy
              </Link>
              <Link href="/terms-and-conditions" className="block text-gray-400 text-sm hover:text-red-400 transition-colors">
